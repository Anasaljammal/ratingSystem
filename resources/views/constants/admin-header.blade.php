     ...
     <section id="sidebar" class="sidebar">
          <div class="main-container">
               ...
               <div class="rows-container">
                    ...
                    <a href="{{url('/reports')}}" class="container" style="{{$type == 'reports'?' border-right: 10px solid blue': ''}}">
                         <img src="{{asset('SVG/contract-pending.svg')}}" />
                         <span>Reports</span>
                    </a>
                    <a href="{{url('/supports')}}" class="container" style="{{$type == 'support'?' border-right: 10px solid blue': ''}}">
     ...
     <header>
          <div class="top-section">
               ...
               <div class="links-container">
                    ...
                    <a href="{{url('/reports')}}" style="{{$type == 'reports'?' background-color: gainsboro': ''}}">Reports</a>
                    <a href="{{url('/supports')}}" style="{{$type == 'support'?' background-color: gainsboro': ''}}">Support</a>
