...
class UserController extends Controller
{
    ...
    public function setActivation(User $user)
    {
        if ($user->is_activated) {
            ...
            return redirect()->back()->with('success', 'this account disactivated successfully');
        } else {
            $user->update([
                'is_activated' => 1
            ]);

            return redirect()->back()->with('success', 'this account activated successfully');
        }
    }
}
